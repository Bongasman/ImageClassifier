...
inputs.add_argument('input_img', default='/home/ImageClassifer/flowers/test/10/image_07104.jpg', nargs='*', action="store", type = str)
inputs.add_argument('checkpoint', default='/home/workspace/paind-project/my-checkpoint.pth', nargs='*', action="store",type = str)
...
classifier_functions.load_model_checkpoing(checkpoint_path)
...
proba = classifier_functions.predict(image_path, model, number_of_outputs, load_gpu)
